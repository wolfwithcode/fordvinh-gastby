      ...
      <Container>
        ...
        <Carousel>
          ...
          <Carousel.Item>
            <img
              className="d-block w-100"
              src={require("../assets/img/ford-ranger-2018-mau-trang-49003j.jpg")}
              alt="Third slide"
            />
          ...
          <Carousel.Item>
            <img
              className="d-block w-100"
              src={require("../assets/img/ford-ranger-2018-mau-xam-49005j.jpg")}
              alt="Third slide"
            />
        ...
        <Container>
            ...
            <Row>
                <Col md={4}>
                    <Card>
                        <Image class="card-img-top w-100 d-block" src={require("../assets/img/ford-ranger-2018-mau-den-49006j.jpg")} />
                    </Card>
                </Col>
                <Col md={4}>
                    <Card>
                        <Image class="card-img-top w-100 d-block" src={require("../assets/img/ford-ranger-2018-mau-trang-49003j.jpg")} />
                    </Card>
                </Col>
                <Col md={4}>
                    <Card>
                        <Image class="card-img-top w-100 d-block" src={require("../assets/img/ford-ranger-2018-mau-xam-49005j.jpg")} />
                    </Card>
                </Col>
                <Col md={4}>
                    <Card>
                        <Image class="card-img-top w-100 d-block" src={require("../assets/img/ford-ranger-xlt-limited-1-99056j.jpg")} />
                    </Card>
                </Col>
                <Col md={4}>
                    <Card>
                        <Image class="card-img-top w-100 d-block" src={require("../assets/img/ford-ranger-xlt-limited-4-99055j.jpg")} />
                    </Card>
                </Col>
                <Col md={4}>
                    <Card>
                        <Image class="card-img-top w-100 d-block" src={require("../assets/img/ford-ranger-xlt-limited-3-99053j.jpg")} />
                    </Card>
                </Col>
            </Row>
        </Container>

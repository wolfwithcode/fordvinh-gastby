...
const valueClasses = ["align-self-center", "py-2", "px-3", HomeStyle.carValue].join(" ");
          ...
          <Col className="col-10 col-md-6 col-lg-4 mx-auto my-3">
            ...
            <div className={cardClasses}>
              ...
              <div className={cardBodyClasses}>
                <div className="car-info d-flex justify-content-between">
                  <div className="car-text text-uppercase">
                    <h6 className={["font-weight-bold", HomeStyle.carInfo].join(" ")}>CAR MAKER</h6>
                    <h6 className={HomeStyle.carInfo}>model</h6>
                  </div>
              ...
              <div className="card-footer text-capitalize d-flex justify-content-between">                
                ...
                <p>
                  <FontAwesomeIcon icon={faCogs}/>Automatic
                </p>
                <p>
                  <FontAwesomeIcon icon={faGasPump}/>50
                </p>
              </div>
            </div>
          </Col>

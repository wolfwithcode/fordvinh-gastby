...
import { faReact,faChrome } from "@fortawesome/free-brands-svg-icons"
import { faCoffee, faCircleNotch, faStar} from '@fortawesome/free-solid-svg-icons'
...
const HomePage = () => {
  ...
  console.log("mystyle ",HomeStyle.promo)
  return (
    <Layout>
      <SEO title="Home page" />
      {/* <Banner />       */}
      <section className={HomeStyle.baogiatonghop}>
        <Container>
          <Jumbotron className={HomeStyle.baogiatonghop__jumbotron}>
            <h3>
              <strong>
            ...
            <Row>
              <Col md={6}>
                <div className={HomeStyle.uudai1}>
              ...
              <Col md={6}>
                <div className={HomeStyle.uudai1}>
                  <p>
                  <FontAwesomeIcon icon={faCoffee} />&nbsp; &nbsp;Quà tặng: Ưu đãi
      ...
      <section className={HomeStyle.bao_gia_ford_ranger}>
        <Container>
          <Jumbotron>
            <h1>
          ...
          <div className="container" id="uudai-ford-ranger">
            <div id="uudai-ford-ranger-chitiet">
              <p className="border-dotted">
              <FontAwesomeIcon icon={faStar} />&nbsp; &nbsp;Gặp mặt hoặc gọi đến
